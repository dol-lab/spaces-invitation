...
jQuery(function ($) {
	...
	var addPasswordEditHook = function () {
		...
		edit.addEventListener('click', function () {
			...
			button.addEventListener('click', function () {
				...
				send(INVITATION_ADMIN_URL.url, 'invitation_update_token', INVITATION_NONCES.invitation_update_token, {
					token: value
	...
	inputs.on('change', function () {
		var self = $(this);
		send(INVITATION_ADMIN_URL.url, 'change_invitation_option', INVITATION_NONCES.invitation_link, {
			option: this.value
